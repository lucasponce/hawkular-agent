    ...
    static {
        try {
            xmlDescription = builder(SubsystemDefinition.INSTANCE)
                    ...
                    .addChild(builder(PrometheusAvailSetDefinition.INSTANCE)
                            .setXmlElementName(PrometheusAvailSetDefinition.AVAIL_SET)
                            .addAttributes(PrometheusAvailSetAttributes.ATTRIBUTES)
                            .addChild(builder(PrometheusAvailDefinition.INSTANCE)
                                    .setXmlElementName(PrometheusAvailDefinition.AVAIL)
                                    .addAttributes(PrometheusAvailAttributes.ATTRIBUTES)))
                    .addChild(builder(PrometheusResourceTypeSetDefinition.INSTANCE)
                            .setXmlElementName(PrometheusResourceTypeSetDefinition.RESOURCE_TYPE_SET)
                            .addAttributes(PrometheusResourceTypeSetAttributes.ATTRIBUTES)
                            .addChild(builder(PrometheusResourceTypeDefinition.INSTANCE)
                                    .setXmlElementName(PrometheusResourceTypeDefinition.RESOURCE_TYPE)
                                    .addAttributes(PrometheusResourceTypeAttributes.ATTRIBUTES)
                                    .addChild(builder(PrometheusResourceConfigDefinition.INSTANCE)
                                            .setXmlElementName(PrometheusResourceConfigDefinition.RESOURCE_CONFIG)
                                            .addAttributes(PrometheusResourceConfigAttributes.ATTRIBUTES))
                                    .addChild(builder(PrometheusOperationDefinition.INSTANCE)
                                            .setXmlElementName(PrometheusOperationDefinition.OPERATION)
                                            .addAttributes(PrometheusOperationAttributes.ATTRIBUTES))))
                    ...
                    .addChild(builder(ManagedServersDefinition.INSTANCE)
                            ...
                            .addChild(builder(RemotePrometheusDefinition.INSTANCE)
                                    .setXmlElementName(RemotePrometheusDefinition.REMOTE_PROMETHEUS)
                                    .addAttributes(RemotePrometheusAttributes.ATTRIBUTES)))
